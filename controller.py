...
def question_two() -> None:
    ...
    print(f"2.- Total income from economic passages: {CURRENCY} {total_income_economic_passages}")
...
def question_three() -> None:
    ...
    print(f"3.- Total income from premium passages: {CURRENCY} {total_income_premium_passages}")



def question_four() -> None:
    # What is the total amount of IGV charged?
    total_IGV_Charge:float = round(sum(v.get_total_IGV_charge() for v in local.flights),2)
...
def question_five() -> None:
    ...
    average_economic_passage:float = round(total_income_economic_passages / total_passages_sale,2)
    print(f"5.- Average value of economic passages: {CURRENCY} {average_economic_passage}")
...
def question_six() -> None:
    ...
    average_premium_passage: float = round(total_income_premium_passages / total_passages_sale,2)
    print(f"6.- Average value of premium passages: {CURRENCY} {average_premium_passage}")
